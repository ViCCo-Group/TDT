...
try check_software_spm25(cfg); end
try get_filenames_spm25(cfg); end
try read_header_spm25(cfg); end
try read_image_spm25(cfg); end
try read_voxels_spm25(cfg); end
try write_image_spm25(cfg); end
try check_software_spm26(cfg); end
try get_filenames_spm26(cfg); end
try read_header_spm26(cfg); end
try read_image_spm26(cfg); end
try read_voxels_spm26(cfg); end
try write_image_spm26(cfg); end
