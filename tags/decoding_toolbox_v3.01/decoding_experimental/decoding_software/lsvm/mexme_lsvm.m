function mexme_lsvm(options)

%
%
% Compile each mex-files of the LSVM package
%
%  Usage
%  ------
%
...
files1  = {'normalize'};
files2  = {'pegasos_train' , 'cddcsvm_train'};
...
try
    ...
    if(~isempty(exception))
        fprintf(['\n Error during compilation, be sure to:\n'...
            ...
            'ii) You did "mex -setup" in matlab prompt before running mexme_lsvm\n']);
    end
end
