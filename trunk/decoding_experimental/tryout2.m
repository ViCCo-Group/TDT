...
cfg.files.mask = {fullfile(base_dir,'benchmark\SPM_files\roi\m1_left.img');...
                  fullfile(base_dir,'benchmark\SPM_files\roi\mt_left.img');...
                  fullfile(base_dir,'benchmark\SPM_files\roi\mt_both.img')};
...
reference = decoding(cfg);


% next step: get results in statistical analysis
load(fullfile(cfg.results.dir,'res_cfg.mat'))
cfg.stats.test = 'permutation';
cfg.stats.tail = 'right';
results = fullfile(cfg.results.dir,'res_accuracy_minus_chance.mat');
reference = spm_select('fplist',cfg.results.dir,'res_accuracy_minus_chance_set.*\.mat$');
