    ...
    if ~isfield(cfg.scale, 'IKnowThatLibsvmCanBeSlowWithoutScaling')
        error('decoding_basic_checks:setting_default_scaling_for_libsvm', ...
           ['NOTE: This is a new warning introduced in TDT version 3.999E 2021/09/09. ' ...
            ...
            'SOLUTION: To prevent this, employ a scaling method, e.g. the one recommended by libsvm (''min0max1'' for ''all'' data).'...
            'To do so, set e.g. cfg.scale.method = ''min0max1'' and cfg.scale.estimation = ''all'' (see help decoding_scale_data). ' ...
