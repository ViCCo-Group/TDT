...
Allefeld, Kai Goergen and John-Dylan Haynes, 'Valid population inference
for information-based imaging: From the second-level *t*-test to
prevalence inference', [*NeuroImage* 2016]
(http://dx.doi.org/10.1016/j.neuroimage.2016.07.040). In that paper
...
The implementation wraps the prevalenceCore.m function that can be found 
on https://github.com/allefeld/prevalence-permutation/releases.
...
The original version of the code, that ca be found at
